...
# Expose ArgoCD UI (PowerShell - use escaped quotes)
kubectl patch svc argocd-server -n argocd --type=merge -p '{\"spec\":{\"type\":\"NodePort\",\"ports\":[{\"port\":443,\"targetPort\":8080,\"nodePort\":30081}]}}'
